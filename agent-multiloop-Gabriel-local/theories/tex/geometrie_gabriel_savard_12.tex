...
%% Patch \@ssect via \AtBeginDocument : corrige Missing number sur \section* + lineno
%% pasj02 charge lineno via \draft mais n'applique pas ce patch.
\AtBeginDocument{%
  \makeatletter
  \let\pasj@orig@ssect\@ssect
  \def\@ssect#1#2#3#4#5{%
    \@ifundefined{nolinenumbers}{}{\nolinenumbers}%
    \pasj@orig@ssect{#1}{#2}{#3}{#4}{#5}%
    \@ifundefined{linenumbers}{}{\linenumbers}}%
  \makeatother
}
